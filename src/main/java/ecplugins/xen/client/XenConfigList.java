...
// XenConfigList.java --
//
// XenConfigList.java is part of ElectricCommander.
//
...
public class XenConfigList
{

    //~ Instance fields --------------------------------------------------------

    private final Map<String, XenConfigInfo> m_configInfo =
        new TreeMap<String, XenConfigInfo>();
    ...
    public void addConfig(
            ...
            String configServer)
    {
        m_configInfo.put(configName, new XenConfigInfo(configServer));
    }
    ...
    private class XenConfigInfo
    {
        ...
        public XenConfigInfo(String server)
        {
            m_server = server;
        }
    }
