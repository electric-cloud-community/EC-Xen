...
# xen.cgi -
#
# Get/set EC-Xen configuration info for UI
#
...
# getCfgList
#
# Return the list of configurations from LabManager
#############################################
sub getCfgList {

    my $gcfg = new ElectricCommander::PropDB($::ec, "/projects/@PLUGIN_NAME@/xen_cfgs");
    ...
    foreach my $cfg (keys %cfgs) {
        my $server = $gcfg->getCol("$cfg/xen_server");
        $xml .= "  <cfg>\n";
        $xml .= "     <name>$cfg</name>\n";
